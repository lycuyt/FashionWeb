        ...
        <div class="row">
            ...
            <form action="" method="post">
                <div class="mb-3  " style="width :50%" >
                    ...
                    <input required name="cartegory_name" type="text" placeholder="Nhập danh mục mới"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
                </div>
                <button name="btn_Them" type="submit" class="btn btn-primary">Thêm</button>
