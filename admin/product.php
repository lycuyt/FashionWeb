                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><span><img width="100" src="uploads/<?php echo $result['product_img']; ?>" alt=""></span></td>
                                        ...
                                        <?php
                                            ...
                                            if($show_img_desc)
                                            {
                                                while($resultA = $show_img_desc->fetch_assoc()){ ?>
                                                    <span><img width="50" height="50" src="uploads/<?php echo $resultA['product_img_desc']; ?>" alt=""></span>
                                            <?php    }
                                            }
                                        ?>
                                    </td> -->
                                    <td><a href="productedit.php?product_id=<?php echo $result['product_id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                                    <td><a href="product_delete.php?product_id=<?php echo $result['product_id']; ?>"><i class="fa-solid fa-trash"></i></a></td>
                                </tr>
                        <?php
                            }
                        }
